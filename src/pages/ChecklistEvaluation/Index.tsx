// Ejemplo de uso del nuevo servicio de evaluaciones para evaluación de evaluador al docente
...
export default function ChecklistEvaluationPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      <h2 className="text-xl font-bold mb-4">Evaluación Evaluador al Docente</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button type="submit" className="bg-blue-600 text-white px-4 py-2 rounded" disabled={enviando}>
          {enviando ? 'Enviando...' : 'Enviar Evaluación Checklist'}
        </button>
      </form>
    </div>
  );
